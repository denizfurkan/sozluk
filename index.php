  ...
  <div class="genel">
     ...
     <style>
      ...
      <div class="orta">
        ...
        <?php 
        $icerikSorgu = "SELECT * FROM entryler ORDER BY RAND() LIMIT 5";
            ...
            <div class="content-entry">
              ...
              <div class="entry-footer">
                ...
                <div class="sag-foter" style="float: right;">
                  ...
                  <a href="http://sozluk.codingtr.com/entry/<?php echo $entry_id;?>"><?php echo $entry_tarih;?></a> <a style="color:#007fae" href="http://sozluk.codingtr.com/yazar/<?php echo $entry_kadi;?>"><?php echo $entry_kadi;?></a>
                
                <div style = "position: relative; left: 220px; top: 2px;" class="p-dropdown">
                <a href="javascript:;" class = "entry-dot"></a>
                <div class="p-dropdown-content">
                    <?php  if($_SESSION['kullaniciAdi'] == $entry_kadi ){echo ' <a href="#" class="text-theme">sil</a><hr>';}?>
                    <?php  if($_SESSION['kullaniciAdi'] == $entry_kadi ){echo ' <a href="/duzenle/'.$entry_id.'" class="text-theme">düzelt</a><hr>';}?>
                    <?php  if($_SESSION['kullaniciAdi'] != $entry_kadi ){echo ' <a href="#" class="text-theme">mesaj gönder</a><hr>';}?>
                    <a href="#" class="text-theme">moderasyon</a>
